    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.OneToOneField( null=True, blank=True, to='Bineta.School' )),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('document_ptr', models.OneToOneField( parent_link=True, auto_created=True,
                                                       primary_key=True, serialize=False, to='Bineta.Document' )),
                ('text', models.TextField(max_length=1024)),
            ],
            options={
                'db_table': 'Correction',
            },
            bases=('Bineta.document',),
        ),
        migrations.CreateModel(
            name='Exam',
            fields=[
                ('document_ptr', models.OneToOneField( parent_link=True, auto_created=True,
                                                       primary_key=True, serialize=False, to='Bineta.Document' )),
                ('matter', models.ForeignKey( to='Bineta.ClassTopic' )),
            ],
            options={
                'db_table': 'Exam',
            },
        ...
        migrations.AddField(
            model_name='submit',
            name='document',
            field=models.ForeignKey( related_name='submit_document', to='Bineta.Document' ),
        ),
        migrations.AddField(
            model_name='submit',
            name='user',
        ...
        migrations.AddField(
            model_name='read',
            name='document',
            field=models.ForeignKey( related_name='read_document', to='Bineta.Document' ),
        ),
        migrations.AddField(
            model_name='read',
            name='user',
        ...
        migrations.AddField(
            model_name='image',
            name='document',
            field=models.ForeignKey( default=None, blank=True, to='Bineta.Document', null=True ),
        ),
        migrations.AddField(
            model_name='document',
            name='level',
            field=models.ForeignKey( to='Bineta.ClassLevel' ),
        ),
        migrations.AddField(
            model_name='document',
            name='school',
            field=models.ForeignKey( to='Bineta.School' ),
        ),
        migrations.AddField(
            model_name='document',
            name='user',
        ...
        migrations.AddField(
            model_name='comment',
            name='document',
            field=models.ForeignKey( related_name='comment_document', to='Bineta.Document' ),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
        ...
        migrations.AddField(
            ...
            name='exam',
            field=models.ForeignKey( to='Bineta.Exam' ),
        ),
    ]
